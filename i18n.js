(function () {
  ...
  var T = {
    es: {
      ...
      /* ── Finques Castellà ── */
      'partners.fc.cat': 'Inmobiliaria · Maresme',
      'partners.fc.name': 'Finques Castellà',
      'partners.fc.desc': 'Más de 50 años de experiencia en el mercado inmobiliario del Maresme. Especialistas en compraventa, alquiler y administración de propiedades en Mataró y comarca. Agencia colegiada API nº 2485.',
      'partners.fc.link': 'Visitar web →',
    ...
    ca: {
      ...
      'partners.sm.link': 'Visitar web →',
      /* ── Finques Castellà ── */
      'partners.fc.cat': 'Immobiliària · Maresme',
      'partners.fc.name': 'Finques Castellà',
      'partners.fc.desc': "Més de 50 anys d'experiència en el mercat immobiliari del Maresme. Especialistes en compravenda, lloguer i administració de propietats a Mataró i comarca. Agència col·legiada API nº 2485.",
      'partners.fc.link': 'Visitar web →',
...
`,
    ...
    en: {
      ...
      /* ── Finques Castellà ── */
      'partners.fc.cat': 'Real Estate · Maresme',
      'partners.fc.name': 'Finques Castellà',
      'partners.fc.desc': 'Over 50 years of experience in the Maresme property market. Specialists in buying, selling, renting and property management in Mataró and the surrounding area. Registered agency API nº 2485.',
      'partners.fc.link': 'Visit website →',
